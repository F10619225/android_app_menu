...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 若查詢結果是空的則寫入 2 筆測試資料
        if(cur.getCount()==0){
            addData("01","章魚燒(8入)","150$");
            addData("02","炙燒鮪魚(一貫)","300$");
            addData("03","海膽軍艦(一貫)","150$");
            addData("04","花枝(一貫)","80$");
            addData("05","炙烤河豚(一貫)","200$");
            addData("06","海老軍艦(一貫)","80$");
            addData("07","鯨魚生魚片(一貫)","350$");
            addData("08","鰻魚(一貫)","300$");
        }
